...
static void
dtor(void *arg, const void *key, size_t len, void *val)
{
...
JNIEXPORT jint JNICALL Java_org_netbsd_liblpm_LPM_insert__JLjava_lang_String_2Ljava_lang_Object_2
...
JNIEXPORT jint JNICALL Java_org_netbsd_liblpm_LPM_insert__J_3BILjava_lang_Object_2
  (JNIEnv *env, jobject obj, jlong lpm_ref, jbyteArray addr_ref, jint pref, jobject value)
{
	lpm_t *lpm;
	jobject val_ref;
	jbyte *addr;
...
JNIEXPORT jobject JNICALL JNICALL Java_org_netbsd_liblpm_LPM_lookup__JLjava_lang_String_2
...
JNIEXPORT jint JNICALL Java_org_netbsd_liblpm_LPM_remove__JLjava_lang_String_2
  (JNIEnv *env, jobject obj, jlong lpm_ref, jstring addr)
{
	lpm_t *lpm;
	const char *addr_s;
...
JNIEXPORT jint JNICALL Java_org_netbsd_liblpm_LPM_remove__J_3BI
